      ...
      <div className="glass-card rounded-xl p-4 sm:p-[18px_20px]">
        ...
        {!kpiReady ? (
          ...
          <>
            ...
            <div className="mt-5 bg-[var(--bg4)] border border-[var(--border2)] rounded-xl p-3">
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-3 py-2 rounded-md text-xs font-semibold bg-[var(--bg3)] text-[var(--text2)] hover:text-[var(--text)] transition-colors shrink-0"
                >
      ...
      <div className="glass-card rounded-xl p-4 sm:p-[18px_20px]">
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <span
              className="px-2 py-1 rounded-md text-[10px] font-bold uppercase tracking-[0.07em] border"
              style={
                queueListTab === 'prioritized'
                  ? { background: 'rgba(239,68,68,0.14)', borderColor: 'rgba(239,68,68,0.35)', color: 'var(--red)' }
                  : { background: 'rgba(234,179,8,0.14)', borderColor: 'rgba(234,179,8,0.35)', color: 'var(--yellow)' }
              }
            >
              {queueListTab === 'prioritized' ? 'Priorizados' : 'Para priorizar'}
            </span>
            <button
              type="button"
